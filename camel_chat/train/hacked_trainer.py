...
from .trainer_pt_utils import (DistributedTensorGatherer, IterableDatasetShard,
...
from .utils import (ADAPTER_SAFE_WEIGHTS_NAME, ADAPTER_WEIGHTS_NAME,
                    ...
                    is_sagemaker_mp_enabled, is_torch_compile_available,
...
if is_accelerate_available():
    ...
    if version.parse(accelerate_version) > version.parse("0.20.3"):
        from accelerate.utils import (load_fsdp_model, load_fsdp_optimizer,
...
class Trainer:
    ...
    def _inner_training_loop(
        self, batch_size=None, args=None, resume_from_checkpoint=None, load_weights=True, trial=None, ignore_keys_for_eval=None
    ):
